...
NB. The long ver in the middle returns all multiples of a number x less than y, 
...
NB.
NB. So, working backwards: the function is finding the remainder of y divided by x, 
...
NB. ---------------------------------------------------------------
NB. The code can be shortened by using a loop ('^:') that shrinks y
NB. by 1 ('<:') each step until the remainder of x | y becomes 0:
